...
steps:
  ...
  transcervical-fracture-of-hip---primary:
    run: transcervical-fracture-of-hip---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  fracture-of-hip-richard---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: transcervical-fracture-of-hip---primary/output
  hip---primary:
    run: hip---primary.cwl
    out:
    - output
  ...
  fracture-of-hip-intracap---primary:
    run: fracture-of-hip-intracap---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dynamic-fracture-of-hip---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: fracture-of-hip-intracap---primary/output
  fracture-of-hip-revision---primary:
    run: fracture-of-hip-revision---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  fracture-of-hip-epiphysis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: fracture-of-hip-revision---primary/output
